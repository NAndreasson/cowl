...
PrincipalExpressionParser::PrincipalExpressionParser(const nsAString &principal)
  : mCurChar(nullptr)
  , mEndChar(nullptr)
{
  mCurToken = principal;
...
PrincipalExpressionParser::~PrincipalExpressionParser()
{
...
bool
PrincipalExpressionParser::hexOctet()
{
  return accept(isValidHexDig) && accept(isValidHexDig);
}

void
PrincipalExpressionParser::resetCurChar(const nsAString& aToken)
{
...
bool
PrincipalExpressionParser::atEndOfPath()
{
...
bool
PrincipalExpressionParser::atValidUnreservedChar()
{
...
bool
PrincipalExpressionParser::atValidSubDelimChar()
{
...
bool
PrincipalExpressionParser::atValidPctEncodedChar()
{
...
// http://tools.ietf.org/html/rfc3986#section-3.3
bool
PrincipalExpressionParser::atValidPathChar()
{
...
bool
PrincipalExpressionParser::hostChar()
{
  if (atEnd()) {
    return false;
  }
...
// (ALPHA / DIGIT / "+" / "-" / "." )
bool
PrincipalExpressionParser::schemeChar()
{
  if (atEnd()) {
    return false;
  }
...
// port = ":" ( 1*DIGIT / "*" )
bool
PrincipalExpressionParser::port()
{
...
bool
PrincipalExpressionParser::subPath()
{
...
bool
PrincipalExpressionParser::path()
{
...
bool
PrincipalExpressionParser::subHost()
{
  uint32_t charCounter = 0;
...
bool PrincipalExpressionParser::schemeSource()
{
...
bool PrincipalExpressionParser::host()
{
...
bool PrincipalExpressionParser::hostSource()
{
  bool isHost  = host();
  if (!isHost) {
...
bool
PrincipalExpressionParser::checkHexOctets(uint32_t hexOctetNr)
{
  uint32_t count = 0;
...
bool
PrincipalExpressionParser::uniquePrincipal()
{
...
bool
PrincipalExpressionParser::appPrincipal()
{
  // check if starts with "app:"
...
PrincipalState
PrincipalExpressionParser::principalExpression()
{
...
PrincipalState
PrincipalExpressionParser::validateFormat(const nsAString& principal)
{
  PrincipalExpressionParser parser(principal);
...
{
  PrincipalState principalState = PrincipalExpressionParser::validateFormat(principal);
